              ...
              contents: [
                ...
                },
                {
                  ...
                  contents: [
                    layoutBoxBaseline(
                      "ชื่อ-สกุล",
                      `${userData.users_fname} ${userData.users_sname}`,
                      4,
                      5
                    ),
                    layoutBoxBaseline(
              ...
              contents: [
                  ...
                  contents: [
                    {
                      ...
                      contents: [
                        ...
                        {
                          type: "text",
                          text: `${userTakecarepersonData.takecare_fname} ${userTakecarepersonData.takecare_sname}`,
                          flex: 3,
                          wrap: true,
                        },
                      ],
                ...
                },
                {
                  ...
                  action: {
                    ...
                    uri: `${WEB_API}/settingTemp?auToken=${
                      userData.users_line_id
                    }&idsetting=${idSetting || ""}`,
                  },
                },
                {
                  ...
                  action: {
                    type: "uri",
                    label: "ตั้งค่าชีพจร",
                    uri: `${WEB_API}/settingHeartRate?auToken=${
                      userData.users_line_id
                    }&idsetting=${idSettingHR || ""}`,
                  },
                },
              ],
            },
  ...
  try {
    ...
    if (userTakecarepersonData) {
      contentTakecareperson = [
        ...
        layoutBoxBaseline(
          "วันเดือนปีเกิด",
          `${moment(userTakecarepersonData.takecare_birthday).format(
            "DD/MM/YYYY"
          )}`,
          4,
          5
        ...
        layoutBoxBaseline(
          "ที่อยู่",
          `${userTakecarepersonData.takecare_number || "-"} หมู่ ${
            userTakecarepersonData.takecare_moo || "-"
          }`,
          4,
          5
        ),
        layoutBoxBaseline(
          "ถนน",
          `${userTakecarepersonData.takecare_road || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
          "ตำบล",
          `${userTakecarepersonData.takecare_tubon || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
          "อำเภอ",
          `${userTakecarepersonData.takecare_amphur || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
          "จังหวัด",
          `${userTakecarepersonData.takecare_province || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
          "รหัสไปรษณีย์",
          `${userTakecarepersonData.takecare_postcode || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
        ...
        layoutBoxBaseline(
          "โรคประจำตัว",
          `${userTakecarepersonData.takecare_disease || "-"}`,
          4,
          5
        ),
        layoutBoxBaseline(
          "ยาที่ใช้ประจำ",
          `${userTakecarepersonData.takecare_drug || "-"}`,
          4,
          5
        ),
      ];
              ...
              contents: [
                ...
                },
                {
                  ...
                  contents: [
                    ...
                    layoutBoxBaseline(
                      "สถานะ",
                      userData.users_status_id.status_name
                    ),
                    layoutBoxBaseline(
                      "ที่อยู่",
                      `${userData.users_number || "-"} หมู่ ${
